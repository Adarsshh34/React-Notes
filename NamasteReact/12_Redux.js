...
# subscribing to the store -> when data in store changes react automatically update the component to show new updated data i.e called subscribing to the store
